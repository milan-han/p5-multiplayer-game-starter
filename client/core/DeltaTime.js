...
export class DeltaTime {
    constructor(config) {
        ...
        this.targetFPS = this.config.ui.anim.target_fps;
        this.maxDeltaTime = this.config.ui.anim.max_delta_time;
        this.minDeltaTime = this.config.ui.anim.min_delta_time;
        this.deltaTimeSmoothing = this.config.ui.anim.delta_time_smoothing;
    ...
    getSimulationTime() {
        return this.renderTime - (this.config.ui.anim.interpolation_delay_ms / 1000);
    }
